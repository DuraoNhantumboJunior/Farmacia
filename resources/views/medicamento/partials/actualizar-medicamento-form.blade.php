    ...
    <form method="post" action="{{ route('update.medicamento') }}" class="mt-6 space-y-6">
        ...
        <div class="flex flex-wrap -mx-3">
            ...
            <div class="w-full sm:w-1/2 px-3 py-3">
                ...
                <x-text-input id="medida" name="medida" type="text" class="mt-1 block w-full read-only:true" :value="old('medida',$medicamento->unidade_medida)" required autofocus autocomplete="medida" />
