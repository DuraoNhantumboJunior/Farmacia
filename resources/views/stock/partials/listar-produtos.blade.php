    ...
    <table class="min-w-full w-full">
        <thead class="bg-gray-400 text-white">
            <tr>
                ...
                <th class="px-15 py-3 mx-16 text-left text-xs font-medium uppercase tracking-wider ">Quantidade</th>
        ...
        <tbody class="bg-white dark:bg-gray-700 text-gray-800 dark:text-gray-200">
            ...
            <tr class="border-t">
                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">António</td>
                <td class="px-6 py-4 whitespace-nowrap text-sm">paracetamol</td>
                <td class="px-6 py-4 whitespace-nowrap text-sm">500 mg</td>
                <td class="px-6 py-4 whitespace-nowrap text-sm">15</td>
                <td class="px-6 py-4 whitespace-nowrap text-sm">25.00</td>
                <td class="px-6 py-4 whitespace-nowrap text-sm">13/09/2029</td>
                <td class="px-6 py-4 whitespace-nowrap text-sm">
                    <a href="actualizar-stock">
