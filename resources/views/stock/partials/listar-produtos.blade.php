<div class="relative overflow-x-auto">
    <table class="min-w-full w-full">
        <thead class="bg-gray-400 text-white">
            <tr>
                <th class="px-10 py-3 mx-16 text-left text-xs font-medium uppercase tracking-wider ">Fornecedor</th>
                <th class="px-15 py-3 mx-16 text-left text-xs font-medium uppercase tracking-wider ">Medicamento</th>
                <th class="px-15 py-3 mx-16 text-left text-xs font-medium uppercase tracking-wider ">Composição Und</th>
                <th class="px-15 py-3 mx-16 text-left text-xs font-medium uppercase tracking-wider ">Comprimidos na cartela</th>
                <th class="px-15 py-3 mx-16 text-left text-xs font-medium uppercase tracking-wider ">Quantidade de Cartelas</th>
                <th class="px-15 py-3 mx-16 text-left text-xs font-medium uppercase tracking-wider ">Preço</th>
                <th class="px-15 py-3 mx-16 text-left text-xs font-medium uppercase tracking-wider ">Validade</th>
                <th class="px-15 py-3 mx-16 text-left text-xs font-medium uppercase tracking-wider">Operações</th>
            </tr>
        </thead>

        <tbody class="bg-white dark:bg-gray-700 text-gray-800 dark:text-gray-200">
            ...
            <tr class="border-t">
                ...
                <td class="pr-6 py-4 whitespace-nowrap text-sm">{{$stock->preco_por_cartela}} {{'Mt'}} </td>
                <td class="pr-6 py-4 whitespace-nowrap text-sm">{{$stock->validade}}</td>
                <td class="pr-6 py-4 whitespace-nowrap text-sm">
                    <a href="actualizar-stock/{{$stock->id}}">
