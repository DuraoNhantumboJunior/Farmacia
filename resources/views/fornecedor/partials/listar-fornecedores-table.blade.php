    ...
    <table class="min-w-full w-full">
        ...
        <tbody class="bg-white dark:bg-gray-700 text-gray-800 dark:text-gray-200">
            ...
            <tr class="border-t">
                ...
                <td class="px-6 py-4 whitespace-nowrap text-sm">Malhampse, Matola, Tsalala casa 23</td>
                <td class="px-6 py-4 whitespace-nowrap text-sm">841234567</td>
                <td class="px-6 py-4 whitespace-nowrap text-sm">antoniocossa@farmaciaLTD.co.mz</td>
                <td class="px-6 py-4 whitespace-nowrap text-sm">136383629</td>
                <td class="px-6 py-4 whitespace-nowrap text-sm">
                    <a href="actualizar-fornecedor">
